...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Better error reporting to identify why credentials fail
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="text-center text-3xl font-extrabold text-slate-900">Sign in to ASTU Smart</h2>
        <p className="mt-2 text-center text-sm text-slate-600">
          Or <Link href="/register" className="font-medium text-blue-600 hover:text-blue-500 transition">create a new student account</Link>
        </p>
      </div>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  type="email"
                  required
                  className="appearance-none block w-full pl-10 pr-3 py-3 border border-slate-300 rounded-xl shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
